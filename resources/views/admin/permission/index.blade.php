                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="add-items d-flex mb-2">
                                  <a href="{{route('admin.permission.create')}}"><button class="add btn btn-icons btn-rounded btn-primary  text-white me-0 pl-12p p-0"><i class="mdi mdi-plus"></i></button></a>
                                </div>
                            </div>
...
@section('scriptjs')
        ...
        <script>
            initializeActionButtons("{{ route('admin.permission') }}", "{{ route('admin.permission') }}");
        </script>
    @stop