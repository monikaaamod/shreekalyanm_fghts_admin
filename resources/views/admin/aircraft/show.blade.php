                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered" id="data">
                                <tbody>
                                    <tr>
                                        <th>Title</th>
                                        <td colspan="12"><b>{{$aircraft->title}}</b></td>
                                    </tr>
                                    <tr>
                                        <th>Description</th>
                                        <td colspan="12"><b>{{$aircraft->description}}</b></td>
                                    </tr>
                        
                                    <tr>
                                        <th>Status</th>
                                        <td>@if($aircraft->status == 'Active')<span
                                    ...
                                    <tr>
                                        <th>Created At</th>
                                        <td>{{\Carbon\Carbon::parse($aircraft->created_at)->format('d M Y')}}</td>
                                    </tr>
                                </tbody>
                            </table>
                    </div>
