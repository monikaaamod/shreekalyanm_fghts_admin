...
@section('content')
 ...
 <div class="main-panel">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <select class="form-control" name="payment_mode" id="payment_mode">
                                                    <option value="">Select</option>
                                                    @foreach($newdata['payment_mode'] as $key=>$val)
                                                        <option @if(isset($post) && $post->payment_mode == $val->id) selected @endif value="{{$val->id}}">{{$val->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <select class="form-control" name="percentage_type" id="percentage_type">
                                                    ...
                                                    <option @if(isset($post) && $post->percentage_type == 'percentage') selected @endif value="percentage">Percentage</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label> Sector Wise </label>
                                                <select class="form-control" name="sector_wise" id="sector_wise">
                                                    <option value="">Select</option>
                                                    <option @if(isset($post) && $post->sector_wise == 'fixed_booking') selected @endif value="fixed_booking">Fixed Booking</option>
                                                    <option @if(isset($post) && $post->sector_wise == 'per_pax') selected @endif value="per_pax">Per Pax</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" value="{{isset($post)?$post->convenience_fee:''}}" id="convenience_fee" name="convenience_fee" type="text" aria-describedby="" placeholder="Enter Convenience Fee">
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
              formHandler.initializeSimpleForm('submitForm', "{{ route('admin.conveniencefee') }}");
