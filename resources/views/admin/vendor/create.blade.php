                                            ...
                                            <div class="col-12 col-sm-5">
                                                <div class="form-group local-forms">
                                                    ...
                                                    <select name="status" id="status"
                                                        class="form-control custom-select">
                                                        <option>Select</option>
                                                        <option @if(isset($post)) @if($post->status == 'New') selected
                                                            @endif @endif value="New">New</option>
                                                        <option @if(isset($post)) @if($post->status == 'Pending')
                                                            selected @endif @endif value="Pending">Pending</option>
                                                        <option @if(isset($post)) @if($post->status == 'Confirm')
                                                            selected @endif @endif value="Confirm">Confirm</option>
                                                        <option @if(isset($post)) @if($post->status == 'Completed')
                                                            selected @endif @endif value="Completed">Completed</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane" id="solid-rounded-justified-tab2">
                            ...
                            <div class="form-group local-forms">
                                ...
                                <div class="row">
                                    ...
                                    <a href="{{url('public/'.$post->aadhar_card)}}">View Document</a>
                                    ...
                                    <div class="form-group local-forms">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <div class="holder">
                                                    <img id="imgPreview2"
                                                        src="{{ isset($post) ? url('public/'.$post->image) : 'https://ekamyoga.com/public/notfound.png' }}"
                                                        alt="pic" name="pan_card" width="50%" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-2">
                                                ...
                                                <input type="hidden" name="pan_card" id="pan_card"
                                                    value="{{isset($post)?$post->pan_card:''}}" />
                                                <img src="@if(isset($post)) @if($post->pan_card){{url('public/'.$post->pan_card)}}@endif  @endif"
                                                    style="height: 50px;" />
                                                <!-- <a href="{{url('public/'.$post->pan_card)}}">View Document</a> -->
                                    ...
                                    <div class="form-group local-forms">
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                ...
                                                <input type="hidden" name="logo" id="logo"
                                                    value="{{isset($post)?$post->gst_doc:''}}" />
                                                <img src="@if(isset($post)) @if($post->gst_doc){{url('public/'.$post->gst_doc)}}@endif  @endif"
                                                    style="height: 50px;" />
                                                <!-- <a href="{{url('public/'.$post->gst_doc)}}">View Document</a> -->
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group local-forms">
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                ...
                                                <input type="hidden" name="logo" id="logo"
                                                    value="{{isset($post)?$post->cheque:''}}" />
                                                <img src="@if(isset($post)) @if($post->cheque){{url('public/'.$post->cheque)}}@endif  @endif"
                                                    style="height: 50px;" />
                                                <!-- <a href="{{url('public/'.$post->cheque)}}">View Document</a> -->
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div>
                        <div class="col-12 col-sm-8">
                            <div class="form-group local-forms">
                                ...
                                <div id="unite_id">
                                    @foreach($data['service_offered'] as $val) @if($val->types == "checkbox")
                                    <h5 style="margin-left: 24px;">{{$val->title}}</h5>

                                    <p>
                                        <input type="checkbox" id="checkbox" style="margin-right: 10px;"
                                            name="checkbox[]" @if(isset($post))@if (in_array($val->id, explode(',',
                                        $post->checkbox))) checked @endif @endif value="{{$val->id}}"
                                        >{!! $val->description !!}
                                    </p>
                                    @endif @endforeach @foreach($data['service_offered'] as $val) @if($val->types ==
                                    "radio")
                                    <h5 style="margin-left: 24px;">{{$val->title}}</h5>

                                    <p><input type="radio" id="radio" style="margin-right: 10px;" name="radio"
                                            @if(isset($post)) {{ ($post->radio == $val->id ) ? 'checked' :'' }} @endif
                                            value="{{$val->id}}">{!! $val->description !!}</p>
                                    @endif @endforeach
                                </div>
                            </div>
                        </div>
            ...
            <div class="tab-pane" id="solid-rounded-justified-tab4">
                <div class="row">
                    ...
                    <div class="col-12 col-md-3 col-sm-8">
                        <div class="box">
                            <div class="js--image-preview js--image-preview-data011"
                                style="background-image:url({{asset($image->pastimage)}})"></div>
                            <div class="upload-options">
                                <label>
                                    <input type="file" accept="image/png, image/jpeg" name="pastimage[]"
                                        ...
                                        accept="image/*" value="{{$image->pastimage}}" />
                                    <p class="ttl">+</p>
                                </label>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-3 mb-3">
                        <label class="text-danger">You Can Upload Max 6 Videos</label>
                    </div>
                    @if(isset($post))
                    @foreach($post->past_work as $image)
                    @if($image->is_image == 0)
                    <div class="col-12 col-md-3 col-sm-8">
                        <div class="box">
                            ...
                            <div class="js--image-preview js--image-preview-data021"
                                style="background-image:url({{asset($image->pastimage)}})">
                                <video controls style='width:100% !important;height: 150px;'>
                                    <source src="{{asset($image->pastimage)}}" type='video/mp4'>
                                </video>
                            </div>
                            <div class="upload-options">
                                <label>
                                    <input type="file" name="is_image[]" accept="video/*" onchange="preview_video(this)"
                                        data-id="021" class="image-upload" />
                                    <p class="ttl">+</p>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-sm-4">
                        <div class="form-group local-forms">
                            ...
                            <input type="text" class="form-control" value="{{$data['video_cat']->category_name}}"
                                id="video_category" readonly name="video_category" type="text" aria-describedby=""
                                placeholder="Enter Video Category">
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-sm-4" style="display: flex;justify-content: end;">
                        <button type="button" onclick="getVideo()" style="height: 35px;" class="btn btn-primary"> +
                        </button>
                    </div>
                    <div class="col-12 col-md-6 col-sm-4">
                        <div class="form-group local-forms">
                            <label>Title <span class="login-danger">*</span></label>
                            <input type="text" class="form-control" value="{{ isset($post) ? $post->video_title : '' }}"
                    ...
                    <div class="col-12 col-md-6 col-sm-4">
                        <div class="form-group local-forms">
                            ...
                            <input type="text" class="form-control" value="{{isset($post)? $post->video_url:''}}"
                        ...
                        <div class="form-group local-forms">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="hidden" name="thumbnail[]" id="thumbnail0" @if(isset($post))
                                        value="{{$post->video_thumbnail}}" @endif>
                                </div>

                                <div class="col-2">

                                    <img id="thumb0" @if(isset($post)) @if($post->video_thumbnail)
                                    src="{{$post->video_thumbnail}}" @else
                                    src="https://pipdigz.co.uk/p3/img/placeholder-square.png" @endif @endif
                    ...
                    <div class="col-12 col-md-6 col-sm-4">
                        <div class="form-group local-forms">
                            ...
                            <textarea class="ckeditor form-control" name="video_description[]" id="video_description"
                                cols="30" rows="10">{{isset($post)? $post->description : ''}}</textarea>
                        </div>
                    </div>
                    <div class="getvid"></div>
                    @endif
                </div>
                {{--
<div class="col-12 col-sm-8">
        ...
        <div class="row">
            ...
            <div class="col-2">
                ...
                <video class="video" controls>
                    <source
                        src="@if(isset($post)) @if($videos->pastimage){{url('public/'.$videos->pastimage)}}@endif @endif"
                        style="height: 50px;" />
                </video>
    ...
    <div class="tab-pane" id="solid-rounded-justified-tab5">
        <div class="row">
            ...
            <div class="col-md-1" style="padding: 15px;">
                <button class="btn mt-2 btn-primary" type="button" onclick="addMoreData()"><i
        ...
        <div class="row">
            ...
            <div class="col-md-1" style="padding: 15px;">
                <button class="btn mt-2 btn-primary" type="button" onclick="addMoreData2()"><i
                        class="fa fa-plus"></i></button>
            </div>
        </div>
        <div class="appenddata12"></div>
    </div>
...
function getVideo() {
    if (coun <= 5) {
        $(".getvid").append(`
                ...
                <div class="row" id="ROWID-${coun}">
                    <div class="col-12 col-md-6 col-sm-4">
                        <div class="form-group local-forms">
                            <label>Video Category <span class="login-danger">*</span></label>
                            <input type="text" class="form-control" value="{{$data['video_cat']->category_name}}" id="video_category" readonly name="video_category"
                                type="text" aria-describedby="" placeholder="Enter Video Category">
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-sm-4" style="display: flex;justify-content: end;">
                        <button type="button" onclick="getVideo()" style="height: 35px;" class="btn btn-primary"> + </button>
                    </div>
                    <div class="col-12 col-md-6 col-sm-4">
                        <div class="form-group local-forms">
                            <label>Title <span class="login-danger">*</span></label>
                            <input type="text" class="form-control"value="{{ isset($post) ? $post->video_title : '' }}" id="video_title" name="video_title[]"
                                type="text" aria-describedby="" placeholder="Enter Title">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-sm-4">
                        <div class="form-group local-forms">
                            <label>Video Url <span class="login-danger">*</span></label>
                            <input type="text" class="form-control" value="{{isset($post)? $post->video_url:''}}" id="video_url${coun}" name="video_url[]" aria-describedby="" placeholder="Enter Youtube Url">
                        </div>
                    </div>    
                    ...
                    <div class="col-12 col-sm-8">
                        <div class="form-group local-forms">
                            <div class="row">
                                <div class="col-6">
                                    <input type="button" class="btn btn-success" onclick="addNewvideo(this);" id="${coun}" value="Generate thumbnail">
                                    <input type="hidden" name="thumbnail[]" id="thumbnail${coun}" @if(isset($post)) value="{{$post->video_thumbnail}}" @endif>
                                </div>
                        
                                <div class="col-2">
                                    
                                    <img id="thumb${coun}" @if(isset($post)) @if($post->video_thumbnail) src="{{$post->video_thumbnail}}" @else src="https://pipdigz.co.uk/p3/img/placeholder-square.png" @endif @endif style="height: 125px;width: 125px;" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 col-sm-4">
                        <div class="form-group local-forms">
                            <label>Description <span class="login-danger">*</span></label>
                            <!-- <input type="text" class="form-control"value="" id="desc" name="desc" aria-describedby="" placeholder="Enter Youtube Url"> -->
                            <textarea class="ckeditor form-control" name="video_description[]" id="video_description" cols="30" rows="10">{{isset($post)? $post->description : ''}}</textarea>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6" style="justify-content: end;display: flex;height: 38px;">
                        <button type="button" onclick="removeVideo(${coun})" class="btn btn-danger"> - </button>
                    </div>
                </div>
        ...
        alert('You Alredy Added Max Videos');
    }
}
