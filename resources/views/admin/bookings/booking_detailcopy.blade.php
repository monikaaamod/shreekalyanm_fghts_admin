                                                                            ...
                                                                            @foreach($flightRoot->OD as $OD) 
                                                                                ...
                                                                                @endphp 
                                                                                    ...
                                                                                    @if(isset($booking->booking_travellers))
                                                                                        ...
                                                                                        @if($traveller->root->bookingroot == $sector)
                                                                                            <tr>
                                                                                                <td>{{$k + 1}}</td>
                                                                                                <td>{{$sector}}</td>
                                                                                                <td>{{$flightRoot->ID}}</td>
                                                                                ...
                                                                                <form id="ticketForm" method="post" action="{{route('admin.booking.create.ticket')}}">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="form-group col-sm-6">
                                                                                            ...
                                                                                            <input type="text" class="form-control" name="pnr_no" id="pnr_no" value="">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="table-responsive">
                                                                                            ...
                                                                                            <tbody>
                                                                                                @if(isset($booking->booking_travellers))
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>@if($traveller->type == 'ADT') ADULT @elseif($traveller->type == 'CHD') CHILD @else INFANT @endif</td>
                                                                                                        <td>
                                                                                                        <input class="form-control" type="text" name="ticket_no[]" id="ticket_no" value=""></td>
                                                                                                        <input type="hidden" name="travel_id[]" value="{{$traveller->id}}">
                                                                                                        <input type="hidden" name="booking_root" id="booking_root" value="{{$FS->dac.'-'.$FS->ac}}">
                                                                                                    </tr>
                                                                                                    @endforeach
                                                                                                @endif
                                                                                            </tbody>
