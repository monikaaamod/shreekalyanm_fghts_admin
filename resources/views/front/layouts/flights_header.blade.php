...
<body>
<header class="top-header pt-1 pb-1">
  <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item ms-5">
                <a class="nav-link" href="https://shreekalyanamtravels.com">Home</a>
              </li>

              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="{{route('index')}}">Flights</a>
              </li>

              <li class="nav-item ms-5">
                <a class="nav-link" href="https://shreekalyanamtravels.com/travels/">Travel Planning</a>
              </li>
              <li class="nav-item ms-5">
                <a class="nav-link" href="https://shreekalyanam.com/weddingvendors">Event Planning</a>
              </li>
              <li class="nav-item ms-5">
                <a class="nav-link" href="https://shreekalyanam.com/videos">Video</a>
              </li>
              <li class="nav-item ms-5">
                <a class="nav-link" href="https://shreekalyanam.com/blogs">Inspirational Blogs</a>
              </li>
            </ul>
          </div>
        </div>
