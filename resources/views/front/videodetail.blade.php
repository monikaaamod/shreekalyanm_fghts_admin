  ...
  <div class="container">
    <div class="menu-bar">
      <ul>
        ...
        <li @if(Route::currentRouteName() == 'weddingvendors') class="active" @endif><a href="{{route('weddingvendors')}}"> Travel Planning</a></li>
        <li @if(Route::currentRouteName() == 'weddingvendors') class="active" @endif><a href="{{route('weddingvendors')}}"> Event Planning</a></li>
...
<section class="banner_video">
    <div class="container">
        <div class="videos-grid-video video-grid vid_des">
            <iframe width="100%" height="100%" src="{{$data->video_url}}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
